...
<head>
    ...
    <title><?=$salon_name?> | Novo Atendente</title>
</head>
    ...
    <main>
        <section class="list-out-form">
            <div class="form-style">
                <form action="pdo/confirm_attendant.php" method="post">
                    <label for="name">Nome:</label>
                    <input type="text" name="name" placeholder="Nome do atendente" required>
                    <input id="button-color-attendant" type="submit" value="Confirmar">
                </form>
            </div>
        </section>
    </main>
