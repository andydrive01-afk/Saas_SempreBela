<?php include_once 'inc/auth.php'; include_once 'inc/settings.php'; ?>
<!DOCTYPE html>
<html lang="pt-BR">
<head>
    <meta charset="UTF-8">
    ...
    <title><?=$salon_name?> | Serviços</title>
</head>
    ...
    <main>
        <section class="list-out">
            <div class="search-bar-wrap">
                <input type="text" id="table-search" placeholder="Buscar serviço pelo nome...">
            </div>
    ...
    <script>
        $(document).ready(function(){
            $('#table-search').on('input', function(){
                ...
                $('#data-table-service table tr:not(:first-child)').each(function(){
